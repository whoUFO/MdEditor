...
- Name: keyboard-shortcuts.spec.ts >> Window Controls >> should have maximize button
- Location: src\test\e2e\keyboard-shortcuts.spec.ts:85:7
...
Locator: locator('[data-testid="maximize-btn"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="maximize-btn"]')
