...
- Name: toc-recent.spec.ts >> Recent Files Feature >> should show recent files tab
- Location: src\test\e2e\toc-recent.spec.ts:84:7
...
Locator: locator('[data-testid="recent-tab"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="recent-tab"]')
