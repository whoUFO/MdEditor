...
- Name: keyboard-shortcuts.spec.ts >> Window Controls >> should have close button
- Location: src\test\e2e\keyboard-shortcuts.spec.ts:90:7
...
Locator: locator('[data-testid="close-btn"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="close-btn"]')
