...
- Name: editor.spec.ts >> Preview Functionality >> should render bold text
- Location: src\test\e2e\editor.spec.ts:46:7
...
Locator: locator('.preview-content').locator('strong')
Expected substring: "bold text"
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('.preview-content').locator('strong')
...
- button "导出 PDF":
  - img
  - text: 导出 PDF
- text: 未命名* | 2 字 | 1 行 UTF-8 | 明亮 | v0.1.0
```
