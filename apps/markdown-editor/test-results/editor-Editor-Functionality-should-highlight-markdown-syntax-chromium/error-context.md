...
- Name: editor.spec.ts >> Editor Functionality >> should highlight markdown syntax
- Location: src\test\e2e\editor.spec.ts:22:7
...
Locator: locator('.preview-content').locator('h1')
Expected substring: "Heading"
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('.preview-content').locator('h1')
...
- button "导出 PDF":
  - img
  - text: 导出 PDF
- text: 未命名* | 3 字 | 2 行 UTF-8 | 明亮 | v0.1.0
```
