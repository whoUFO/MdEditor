...
- Name: file-operations.spec.ts >> Resizer Functionality >> should resize panes by dragging
- Location: src\test\e2e\file-operations.spec.ts:76:7

# Error details

```
Error: mouse.move: y: expected float, got undefined
```

```
Error: locator.boundingBox: Test ended.
Call log:
  - waiting for locator('.resizer')
    - locator resolved to visible <div class="resizer" data-testid="resizer"></div>
