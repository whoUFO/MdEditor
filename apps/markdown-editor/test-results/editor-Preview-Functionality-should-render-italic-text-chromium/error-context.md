...
- Name: editor.spec.ts >> Preview Functionality >> should render italic text
- Location: src\test\e2e\editor.spec.ts:55:7
...
Locator: locator('.preview-content').locator('em')
Expected substring: "italic text"
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('.preview-content').locator('em')
