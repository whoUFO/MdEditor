...
- Name: keyboard-shortcuts.spec.ts >> Window Controls >> should have minimize button
- Location: src\test\e2e\keyboard-shortcuts.spec.ts:80:7
...
Locator: locator('[data-testid="minimize-btn"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="minimize-btn"]')
