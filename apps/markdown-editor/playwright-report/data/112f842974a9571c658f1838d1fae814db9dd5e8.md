...
- Name: editor.spec.ts >> Preview Functionality >> should render code block
- Location: src\test\e2e\editor.spec.ts:64:7
...
Locator: locator('.preview-content').locator('pre code')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.preview-content').locator('pre code')
...
- button "导出 PDF":
  - img
  - text: 导出 PDF
- text: 未命名* | 3 字 | 3 行 UTF-8 | 明亮 | v0.1.0
```
