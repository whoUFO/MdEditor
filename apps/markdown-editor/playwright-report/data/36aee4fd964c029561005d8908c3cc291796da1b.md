...
- Name: editor.spec.ts >> Toolbar Functionality >> should display all toolbar buttons
- Location: src\test\e2e\editor.spec.ts:98:7
...
Locator: locator('[data-testid="export-btn"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="export-btn"]')
