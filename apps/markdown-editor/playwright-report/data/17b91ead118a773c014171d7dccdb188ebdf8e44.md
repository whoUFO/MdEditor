...
- Name: keyboard-shortcuts.spec.ts >> Keyboard Shortcuts >> should toggle bold with Ctrl+B
- Location: src\test\e2e\keyboard-shortcuts.spec.ts:8:7
...
- button "导出 PDF":
  - img
  - text: 导出 PDF
- text: 未命名* | 1 字 | 1 行 UTF-8 | 明亮 | v0.1.0
```
